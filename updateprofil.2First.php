...
<?php
$result = mysqli_query($con,"SELECT * FROM  Employees WHERE Employee_name='salma'");
$i=0;
...
<td><a href="updateMyProfile.2.php?Employee_name=<?php echo $row["Employee_name"]; ?>">Update</a>
