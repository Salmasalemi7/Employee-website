 ...
 <div class="container-fiuid">
 	<h3 class="text-center">chat...</h3>
 		...
 		<div class="well" id="chatbox">
 		 <p>
 		 	<span style="color: red">salma:</span>
 		 	<span style="color: blue">Hello Queen !</span>
 	...
 	<form id="mychatform">
 		...
 		<button  type="button"class="btn btn-success btn-lg" id="sendMyMessage"> Send Message</button>
 	</form>
 </div>
