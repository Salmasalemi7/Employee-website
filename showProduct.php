...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   ...
   <title> KACST- Show Product</title>
...
echo "<tr>
    ...
    <th>Product Qaninty </th> 

  </tr>";
while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
echo "<tr><td>" . $row['ProductPR_id'] . "</td><td>" . $row['Product_type'] ."</td><td>" . $row['Product_qaninty'] ."</td></tr>";}  //$row['index'] the index here is a field name}
