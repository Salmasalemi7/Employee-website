...
echo "<tr><td>" . $row['Order_id'] . "</td><td>" . $row['Product_id'] ."</td><td>" . $row['Employee_id'] ."</td><td>" . $row['HR_id'] ."</td><td>"  .$row['orderSt'] ."</td></tr>";}  //$row['index'] the index here is a field name}
...
?>
<a href="myprofile2.php">Go Back </a>
</body>
</html>