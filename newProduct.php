...
<form action="DBadd_product.php" method="post"> 
  ...
  <div class="input-group">
   ...
   <div class="input-group">
  <label>Product qaninty:</label>
      <input type="text" name="Product_qaninty" required />
  </div>
<div class="input-group">
    <button onclick="myFunction()" type="submit" name="submit" class="btn">ADD</button>
  </div>
</form>
</body>
</html>
