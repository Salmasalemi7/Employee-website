...
<?php
$result = mysqli_query($con,"SELECT * FROM  Employees WHERE Employee_name='sara saad'");
$i=0;
...
<td><a href="updateMyProfile.3.php?Employee_name=<?php echo $row["Employee_name"]; ?>">Update</a>
